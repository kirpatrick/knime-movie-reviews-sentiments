...
3. Download the [KNIME-Workflow-MovieSentimentAnalysis.knwf](https://drive.google.com/uc?export=download&id=1quOqaI6Lb8T1lI-uGOzJSaZ--cVnv3DB) solution solution workflow (~64MB).
